...
// => Temporal.PlainYearMonth <2019-06>
```
...
```javascript
ym = Temporal.PlainYearMonth.from('2019-06'); // => Temporal.PlainYearMonth <2019-06>
ym = Temporal.PlainYearMonth.from('2019-06-24'); // => Temporal.PlainYearMonth <2019-06>
ym = Temporal.PlainYearMonth.from('2019-06-24T15:43:27'); // => Temporal.PlainYearMonth <2019-06>
ym = Temporal.PlainYearMonth.from('2019-06-24T15:43:27Z'); // => Temporal.PlainYearMonth <2019-06>
ym = Temporal.PlainYearMonth.from('2019-06-24T15:43:27+01:00[Europe/Brussels]');
  // => Temporal.PlainYearMonth <2019-06>
ym === Temporal.PlainYearMonth.from(ym); // => false

ym = Temporal.PlainYearMonth.from({ year: 2019, month: 6 }); // => Temporal.PlainYearMonth <2019-06>
...
ym = Temporal.PlainYearMonth.from({ year: 2001, month: 13 }, { overflow: 'constrain' });
  // => Temporal.PlainYearMonth <2001-12>
/* WRONG */ ym = Temporal.PlainYearMonth.from({ year: 2001, month: 13 }, { overflow: 'reject' });
  // => throws
```
<!-- prettier-ignore-end -->
...
ym.with({ month: 12 }); // => Temporal.PlainYearMonth <2019-12>
```
...
```javascript
ym = Temporal.PlainYearMonth.from('2019-06');
ym.add({ years: 20, months: 4 }); // => Temporal.PlainYearMonth <2039-10>
```
...
```javascript
ym = Temporal.PlainYearMonth.from('2019-06');
ym.subtract({ years: 20, months: 4 }); // => Temporal.PlainYearMonth <1999-02>
```
...
ym.until(other);                            // => Temporal.Duration <P12Y10M>
ym.until(other, { largestUnit: 'months' }); // => Temporal.Duration <P154M>
other.until(ym, { largestUnit: 'months' }); // => Temporal.Duration <-P154M>
...
ym.toPlainDate({ day: 1 }).until(other.toPlainDate({ day: 1 }), { largestUnit: 'days' }); // => Temporal.Duration <P4687D>
```
<!-- prettier-ignore-end -->
...
ym.since(other); // => Temporal.Duration <P12Y10M>
```
...
```javascript
ym = Temporal.PlainYearMonth.from('2019-06');
ym.toPlainDate({ day: 24 }); // => Temporal.PlainDate <2019-06-24>
```
