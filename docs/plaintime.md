...
```javascript
// Leet hour
time = new Temporal.PlainTime(13, 37); // => Temporal.PlainTime <13:37:00>
```
...
```javascript
time = Temporal.PlainTime.from('03:24:30'); // => Temporal.PlainTime <03:24:30>
time = Temporal.PlainTime.from('1995-12-07T03:24:30'); // => Temporal.PlainTime <03:24:30>
time = Temporal.PlainTime.from('1995-12-07T03:24:30Z'); // => Temporal.PlainTime <03:24:30>
time = Temporal.PlainTime.from('1995-12-07T03:24:30+01:00[Europe/Brussels]');
  // => Temporal.PlainTime <03:24:30>
...
time = Temporal.PlainTime.from({ hour: 19, minute: 39, second: 9 }); // => Temporal.PlainTime <19:39:09>
time = Temporal.PlainTime.from(Temporal.PlainDateTime.from('2020-02-15T19:39:09'));
  // => Temporal.PlainTime <19:39:09>
...
time = Temporal.PlainTime.from({ hour: 15, minute: 60 }, { overflow: 'constrain' });
  // => Temporal.PlainTime <15:59:00>
time = Temporal.PlainTime.from({ hour: 15, minute: -1 }, { overflow: 'constrain' });
  // => Temporal.PlainTime <15:00:00>
/* WRONG */ time = Temporal.PlainTime.from({ hour: 15, minute: 60 }, { overflow: 'reject' });
  // => throws
/* WRONG */ time = Temporal.PlainTime.from({ hour: 15, minute: -1 }, { overflow: 'reject' });
  // => throws
```
<!-- prettier-ignore-end -->
...
```javascript
time = Temporal.PlainTime.from('19:39:09.068346205');
time.add({ minutes: 5, nanoseconds: 800 }); // => Temporal.PlainTime <19:44:09.068347005>
```
...
```javascript
time = Temporal.PlainTime.from('19:39:09.068346205');
time.subtract({ minutes: 5, nanoseconds: 800 }); // => Temporal.PlainTime <19:34:09.068345405>
```
...
time.until(Temporal.PlainTime.from('22:39:09.068346205')); // => Temporal.Duration <PT2H25M48.096948106S>
time.until(Temporal.PlainTime.from('19:39:09.068346205')); // => Temporal.Duration <-PT34M11.903051894S>
...
```javascript
time = Temporal.PlainTime.from('20:13:20.971398099');
time.since(Temporal.PlainTime.from('19:39:09.068346205')); // => Temporal.Duration <PT34M11.903051894S>
time.since(Temporal.PlainTime.from('22:39:09.068346205')); // => Temporal.Duration <-PT2H25M48.096948106S>
```
...
time.toPlainDateTime(date); // => Temporal.PlainDateTime <2006-08-24T15:23:30.003>
```
