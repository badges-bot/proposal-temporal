...
epoch = new Temporal.Instant(0n); // => Temporal.Instant <1970-01-01T00:00:00Z>
// Dates before the Unix epoch are negative
turnOfTheCentury = new Temporal.Instant(-2208988800000000000n); // => Temporal.Instant <1900-01-01T00:00:00Z>
```
...
epoch = Temporal.Instant.fromEpochSeconds(0); // => Temporal.Instant <1970-01-01T00:00:00Z>
turnOfTheCentury = Temporal.Instant.fromEpochSeconds(-2208988800); // => Temporal.Instant <1900-01-01T00:00:00Z>
```
...
instant = Temporal.Instant.fromEpochMilliseconds(legacyDate.getTime()); // => Temporal.Instant <1995-12-17T03:24:00Z>
...
timestamp.toZonedDateTimeISO('Europe/Berlin'); // => Temporal.ZonedDateTime <2019-03-31T01:45:00+01:00[Europe/Berlin]>
timestamp.toZonedDateTimeISO('UTC'); // => Temporal.ZonedDateTime <2019-03-31T00:45:00+00:00[UTC]>
timestamp.toZonedDateTimeISO('-08:00'); // => Temporal.ZonedDateTime <2019-03-30T16:45:00-08:00[-08:00]>
```
...
epoch.toZonedDateTime({ timeZone, calendar: 'gregory' });
  // => Temporal.ZonedDateTime <1969-12-31T19:00:00-05:00[America/New_York][u-ca=gregory]>
...
zdt = epoch.toZonedDateTime({ timeZone, calendar });
  // => Temporal.ZonedDateTime <1970-01-01T09:00:00+09:00[Asia/Tokyo][u-ca=japanese]>
...
missionLength = startOfMoonMission.until(endOfMoonMission, { largestUnit: 'hours' });
  // => Temporal.Duration <PT195H18M35S>
...
epoch.toZonedDateTimeISO('UTC').until(
  ...
  // => Temporal.Duration <P31Y8M8DT1H46M40S>
```
<!-- prettier-ignore-end -->
...
epoch = Temporal.Instant.fromEpochSeconds(0);
billion = Temporal.Instant.fromEpochSeconds(1e9);
billion.since(epoch); // => Temporal.Duration <PT1000000000S>
```
...
instant.round({ smallestUnit: 'second' }); // => Temporal.Instant <2019-03-30T02:46:00Z>
// Round to an increment of a unit, e.g. an hour:
instant.round({ roundingIncrement: 60, smallestUnit: 'minute' });
  // => Temporal.Instant <2019-03-30T03:00:00Z>
...
instant.round({ roundingIncrement: 60, smallestUnit: 'minute', roundingMode: 'floor' });
  // => Temporal.Instant <2019-03-30T02:00:00Z>
```
<!-- prettier-ignore-end -->
