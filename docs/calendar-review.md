...
date.with({ day: 1 }); // => Temporal.PlainDate <2019-02-06[u-ca=hebrew]>
...
inFourMonths.withCalendar('iso8601'); // => Temporal.PlainDate <2019-06-26>
date.until(inFourMonths, { largestUnit: 'months' }); // => Temporal.Duration <P4M>
```
